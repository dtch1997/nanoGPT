...
python train.py config/train_gelu-2l-mod_shakespeare-char.py --out_dir=gelu-2l-100 --per_layer_weight="[1,0,0]" --wandb_project=sweep_coefficients --wandb_run_name=gelu-2l-100
